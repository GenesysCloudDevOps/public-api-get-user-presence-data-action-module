A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get User Presence
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-user-presence-data-action-module.git?ref=main"
    action_name        = "Get User Presence"
